	...
	public function index() {
		...
		if ($product_info) {
			...
			foreach ($discounts as $discount) {
				$disc = ($product_info['price']*$discount['price'])/100;
				$price = $product_info['price'] - $disc;
				$data['discounts'][] = array(
					'quantity' => $discount['quantity'],
					'price'    => $discount['price']/*$this->currency->format($this->tax->calculate($discount['price'], $product_info['tax_class_id'], $this->config->get('config_tax')))*/
				);
			}
