...
class ControllerExtensionModule extends Controller {
	...
	public function index() {
		...
		if( isset($_GET['design']) && $_GET['design'] == "featured" ){
			$this->document->setTitle("Produk Unggulan");
		}else
	...
	public function getList() {
		...
		if( isset($_GET['design']) && $_GET['design'] == "featured" ){
			...
			$data['heading_title'] = "Produk Unggulan";
			$data['text_list'] = "Daftar Produk Unggulan";
		}else{
		...
		$data['addfeatured'] = $this->url->link('module/featured', 'token=' . $this->session->data['token'], 'SSL');
		...
		if ($files) {
			foreach ($files as $file) {
               	if( isset($_GET['design']) && $_GET['design'] == "featured" ){
               		$f = explode('/', $file);
	                $module_name =  explode('.',end($f))[0];
	                if( $module_name != "featured" ) continue;
               	}
