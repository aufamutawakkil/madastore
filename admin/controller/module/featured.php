...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module', 'token=' . $this->session->data['token']."&design=featured", 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module', 'token=' . $this->session->data['token']."&design=featured", 'SSL')
		);
		...
		$data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token']."&design=featured", 'SSL');
