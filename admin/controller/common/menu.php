...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_grid_banner'] = $this->language->get('text_grid_banner');
		...
		$data['grid_banner'] = $this->url->link('design/gridbanner', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['product_featured'] = $this->url->link('extension/module', 'token=' . $this->session->data['token']."&design=featured", 'SSL');

		$data['slide'] = $this->url->link('module/slideshow', 'token=' . $this->session->data['token']."&module_id=37", 'SSL');

		$data['carousel'] = $this->url->link('module/carousel', 'token=' . $this->session->data['token']."&module_id=39", 'SSL');
