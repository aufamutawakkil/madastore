      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-option" class='hidden' data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <li><a href="#tab-ftp" class='hidden' data-toggle="tab"><?php echo $tab_ftp; ?></a></li>
            <li><a href="#tab-mail" data-toggle="tab"><?php echo $tab_mail; ?></a></li>
            <li><a href="#tab-server" class='hidden' data-toggle="tab"><?php echo $tab_server; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-admin-language"><?php echo "Bahasa"; ?></label>
                <div class="col-sm-10">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="config_encryption" rows="5"  id="input-encryption" class="form-control"><?php echo $config_encryption; ?></textarea>
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="config_file_mime_allowed" rows="5"  id="input-file-mime-allowed" class="form-control"><?php echo $config_file_mime_allowed; ?></textarea>
                </div>
              </div>
            </fieldset>
            <fieldset>
