  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['hFref']; ?>"><?php echo $breadcrumb['text']; ?></a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
           ...
           <!--  <li><a href="#tab-discount" data-toggle="tab"><?php //echo $tab_discount; ?></a></li> -->
            <li><a href="#tab-special" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group hidden">
                ...
                <div class="col-sm-10">
                  <input type="hidden" name="model" value="<?php echo $model== "" ? $model_generator : $model; ?>" placeholder="<?php echo $entry_model; ?>" id="input-model" class="form-control" />
                  <?php if ($error_model) { ?>
              ...
              <div class="form-group hidden">
                <input type='hidden' value='1' name='shipping' />
              ...
              <div class="form-group hidden">
                ...
                <div class="col-sm-10">
                  <input type="hidden" name="keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="tags" id="product-category<?php echo $product_category['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_category['name']; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="related" value=""  class="form-control" />
                  <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_relateds as $product_related) { ?>
                    <div class="tags"  id="product-related<?php echo $product_related['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related['name']; ?>
                      ...
                      <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              ...
                              <td class="text-right"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]" class="form-control">
                                ...
                                <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price]" value="<?php echo substr($product_option_value['price'],0,-5); ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
                          ...
                          <tfoot>
                            <tr>
                              <td colspan='5' ></td>
                              <td class="text-left"><button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');" data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button>
                              </td>
                            </tr>
                          </tfoot>
                        </table>
            ...
            <div class="tab-pane hidden" id="tab-discount">
              <div class="table-responsive">
                <table id="discount" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php echo $entry_customer_group; ?></td>
                  ...
                  <tbody>
                    ...
                    <tr id="discount-row<?php echo $discount_row; ?>">
                      ...
                      <td class="text-right hidden"><input type="text" name="product_discount[<?php echo $discount_row; ?>][priority]" value="<?php echo $product_discount['priority']; ?>" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="product_discount[<?php echo $discount_row; ?>][price]" value="<?php echo substr($product_discount['price'],0,-5); ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
              ...
              <div class="table-responsive">
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php $special_row = 0;  $isProdukSpecialExist = false; ?>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="4"></td>
                      <td class="text-left">
                          <?php if( !$isProdukSpecialExist ){?>
                              <button type="button" id='add-special' onclick="addSpecial();" 
                                 data-toggle="tooltip" title="<?php echo $button_special_add; ?>" 
            ...
            <div class="tab-pane" id="tab-seo">
              <ul class="nav nav-tabs hidden" id="language">
                <?php foreach ($languages as $language) { ?>
                <li class="<?php echo ($language['language_id'] == 2 ) ? 'active' : '';?>"><a href="#1language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>

              <div class="tab-content">
              <?php foreach ($languages as $language) { ?>
                <div class="tab-pane <?php echo ($language['language_id'] == 2 ) ? 'active' : '';?>" id="1language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-category').append('<div id="product-category' + item['value'] + '" class="tags"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_category[]" value="' + item['value'] + '" /></div>');
	}
});
...
$('input[name=\'related\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-related').append('<div id="product-related' + item['value'] + '" class="tags"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_related[]" value="' + item['value'] + '" /></div>');
	}
});
...
function addOptionValue(option_row) {
	...
	/*html += '<td> <input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][subtract]" value="1"></td>';*/
...
function addDiscount() {
    ...
    <?php } ?>
    html += '  </select></td>';
    html += '  <td class="text-right"><input type="text" name="product_discount[' + discount_row + '][quantity]" value="" placeholder="Jumlah" class="form-control" /></td>';
    html += '  <td class="text-right" style="display:none;"><input type="text" name="product_discount[' + discount_row + '][priority]" value="1" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>';
...
function delSpecial(){
  $("#add-special").show();
  $('#special-row<?php echo $special_row; ?>').remove();
...
<!-- Script ini untuk manyamakan semua bahasa nama koleksi  -->
<script type="text/javascript">
$(function(){
  $(document).on('keyup',"#input-name2",function(){
    var val = $(this).val();
    console.log(val);

    $("#input-name3").val(val);
    $("#input-meta-title2").val(val);    //meta title indo
    $("#input-meta-title3").val(val);    //meta title eng
