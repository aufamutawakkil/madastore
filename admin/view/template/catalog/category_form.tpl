        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <!-- <div class="tab-pane" id="language<?php echo $language['language_id']; ?>"> -->
                  ...
                  <div class="form-group required <?= $language['language_id'] == 3 ? 'hidden' : ''; ?> ">
            ...
            <script type="text/javascript">
                $(function(){
                  $("#input-name2").on('keyup',function(){
                    var val = $(this).val();
                    $("#input-name3").val(val);
                    $("#input-meta-title2").val(val);
                    $("#input-meta-title3").val(val);
                  })
                })
            </script>
            ...
            <div class="tab-pane" id="tab-seo">
                <ul class="nav nav-tabs hidden" id="language">
                <?php foreach ($languages as $language) { ?>
                <li class="<?php echo $language['name'] == 'Indonesia' ? 'active' : '';?>"
                ><a href="#1language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php }?>
                </ul>
                 <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane <?php echo $language['name'] == 'Indonesia' ? 'active' : '';?>" id="1language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" placeholder='SEO Keywords' name="keyword" value="<?php echo $keyword; ?>" id="input-keyword" class="form-control" />
