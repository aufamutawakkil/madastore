        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-seo">
              <ul class="nav nav-tabs hidden" id="language">
                <?php foreach ($languages as $language) { ?>
                <li class="<?= ($language['language_id'] == '2') ? 'active' : ''; ?>" ><a href="#1language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
            <div class="tab-pane <?=($language['language_id'] == '2') ? 'active' : '';?>" id="1language<?php echo $language['language_id']; ?>">
                    <div class="form-group required">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="SEO Keywords" id="input-keyword" class="form-control" />
...
<script type="text/javascript">
  $(function(){
    $("#input-title2").on('keyup',function(){
      var val = $(this).val();
      $("#input-title3").val(val);
      $("#input-meta-title2").val(val);
      $("#input-meta-title3").val(val);
    })

    $("#input-description2").on('keyup',function(){
      $("#input-description3").html( $(this).val() )
    })
  })
</script>
