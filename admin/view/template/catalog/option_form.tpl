  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group" style='width:100% !important'><!-- <span class="input-group-addon"><img src="view/image/flags/<?php //echo $language['image']; ?>" title="<?php //echo $language['name']; ?>" /></span> -->
                <input  type="<?php echo $language['language_id'] == '3' ? 'hidden' : 'text'; ?>" name="option_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($option_description[$language['language_id']]) ? $option_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control input-name-option " />
        ...
        <script type="text/javascript">
            $(function(){
                $(document).on('keyup','.name-value-option',function(){
                    var val = $(this).val();
...
function addOptionValue() {
	...
	html += '      <!--<span class="input-group-addon"><img src="view/image/flags/<?php //echo $language['image']; ?>" title="<?php //echo $language['name']; ?>" /></span>--><input type="<?php echo $language['language_id'] == '3' ? 'hidden' : 'text'; ?>" name="option_value[' + option_value_row + '][option_value_description][<?php echo $language['language_id']; ?>][name]" value="" placeholder="<?php echo $entry_option_value; ?>" class="form-control name-value-option" />';
    html += '    </div>';
	<?php } ?>
	html += '  </td>';
