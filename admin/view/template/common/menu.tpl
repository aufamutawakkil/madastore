<ul id="menu">
  ...
  <li id="design"><a class="parent"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_design; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $product_featured ; ?>"> Produk Unggulan </a></li>
      <li><a href="<?php echo $slide; ?>">Slide Show</a></li>
      <li><a href="<?php echo $carousel; ?>">Carousel</a></li>
      <li><a href="<?php echo $grid_banner; ?>"><?=$text_grid_banner?></a></li>
    </ul>
  </li>
  ...
  <li id="system"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
    <ul>
      ...
      <li class='hidden'><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
      ...
      <li class='hidden'><a class="parent"><?php echo $text_tools; ?></a>
        <ul>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    <ul>
      ...
      <li><a class="parent"><?php echo $text_customer; ?></a>
        <ul>
          <li class='hidden'><a href="<?php echo $report_customer_online; ?>"><?php echo $text_report_customer_online; ?></a></li>
