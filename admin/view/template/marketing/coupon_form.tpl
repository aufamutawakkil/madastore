        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <?php  echo ($type == 'f' || $type == 'F') ?  "<span class='typediscount'> Diskon bertipe harga (Rupiah) </span>" : "<span class='typediscount'> Diskon bertipe Prosentase (%) </span>"; ?>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-discount"><?php echo $entry_discount; ?></label>
                <div class="col-sm-8">
                  <input type="text" name="discount" value="<?php echo substr($discount,0,-5); ?>" placeholder="<?php $entry_discount ?>" id="input-discount" class="form-control" />
                </div>
                  ...
                  $(function(){
                      $("#input-type").on("change",function(){ 
                          switch( $(this).val() ){
                            case "P" :
                            case 'p' :
                                    $(".typediscount").text("Diskon bertipe Prosentase (%)");
                                    $("input[name='discount']").attr("placeholder","Diskon (%) ");
                                    break;

                            case "F" :
                            case 'f' :
                                $(".typediscount").text("Diskon bertipe Harga (Rupiah)");
                                $("input[name='discount']").attr("placeholder","Diskon (Rupiah)");
                                break;
              ...
              <div class="form-group" style='clear:both'>
                ...
                <div class="col-sm-10">
                  <input type="text" name="total" value="<?php echo substr($total,0,-5); ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
                </div>
              </div>
              <div class="form-group">
