    ...
    <div class="container-fluid">
      ...
      <?php
          if ( isset($_GET['design']) && $_GET['design'] == "featured" ){
            echo ' <div class="pull-right"><a href="'.$addfeatured.'" data-toggle="tooltip" title="Tambah" class="btn btn-primary"><i class="fa fa-plus"></i></a></div>';
          }else{
        ?>
      <ul class="breadcrumb">
...
<?php
    if( isset($_GET['design']) && $_GET['design'] == 'featured' ){
      echo " <script > $('table tr:nth-child(1)').remove() </script> ";
    }
?>
