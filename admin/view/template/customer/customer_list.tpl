...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary hidden"><i class="fa fa-plus"></i></a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($customer['approve']) { ?>
                    ...
                    <?php } else { ?>
                    <button type="button" class="btn btn-success hidden" disabled><i class="fa fa-thumbs-o-up"></i></button>
                    <?php } ?>
                    <div class="btn-group" data-toggle="tooltip" title="<?php echo"Login"; ?>">
                    ...
                    <a href="<?php echo $customer['unlock']; ?>" data-toggle="tooltip" title="<?php echo $button_unlock; ?>" class="btn btn-warning hidden"><i class="fa fa-unlock"></i></a>
                    <?php } else { ?>
                    <button type="button" class="btn btn-warning hidden" disabled><i class="fa fa-unlock"></i></button>
                    <?php } ?>
