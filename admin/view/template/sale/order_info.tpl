        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <td class="text-left hidden"><?php echo $column_model; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                ...
                <?php } ?>
                <?php } ?></td>
              <td class="text-left hidden"><?php echo $product['model']; ?></td>
            ...
            <?php } ?>
            <?php foreach ($totals as $total) { if( $total['title'] == "Flat Shipping Rate" ) $total['title'] = 'Biaya Pengiriman'; ?>
            <tr>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-history">
            ...
            <div class="text-right">
              <button id="button-history" data-loading-text="<?php echo "Menambahkan..."; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_history_add; ?></button>
            </div>
          </div>
