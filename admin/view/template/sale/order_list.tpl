    ...
    <div class="container-fluid">
      <div class="pull-right">
       <!--  <button type="submit" id="button-shipping" form="form-order" formaction="<?php //echo $shipping; ?>" data-toggle="tooltip" title="<?php //echo $button_shipping_print; ?>" class="btn btn-info"><i class="fa fa-truck"></i></button> -->
        <button type="submit" id="button-invoice" form="form-order" formaction="<?php echo $invoice; ?>" data-toggle="tooltip" title="<?php echo "Print Invoice" ?>" class="btn btn-info"><i class="fa fa-print"></i></button>
       <!--  <a href="<?php //echo $add; ?>" data-toggle="tooltip" title="<?php //echo "Tambah Pesanan"; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a> --></div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo "Lihat Detail" ?>" class="btn btn-info"><i class="fa fa-eye"></i></a> <!-- <a href="<?php //echo $order['edit']; ?>" data-toggle="tooltip" title="<?php //echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> -->
